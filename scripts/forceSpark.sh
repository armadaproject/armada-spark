#!/bin/bash
set -e
mvn --batch-mode clean -DskipTests install
...
if true; then
  ...
  if true; then
    ...
    # ./build/mvn --batch-mode -DskipTests package -Pkubernetes -Pscala-$SCALA_BIN_VERSION
    # ./build/mvn --batch-mode -DskipTests package -Pkubernetes -Pscala-$SCALA_BIN_VERSION -rf :spark-examples_2.12
