...
object TestConstants {
  ...
  val JobWatchTimeout: FiniteDuration   = 900.seconds // Max time for job to complete (15 minutes)
  ...
  val IngressCreationTimeout: FiniteDuration = 90.seconds // Max time to wait for ingress creation
